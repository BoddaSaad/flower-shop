<div class="grid grid-cols-1 xl:grid-cols-4 gap-5">
    ...
    @else
        <div class="rounded-xl border justify-center items-center flex flex-col gap-5 h-96 mt-10 col-span-full">
            <x-heroicon-o-shopping-cart class="size-16 text-slate-400"/>
            <h3 class="text-slate-400 font-semibold text-xl">لا توجد منتجات في العربة</h3>
        </div>
    @endif
</div>
